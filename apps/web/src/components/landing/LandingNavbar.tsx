    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {user ? (
            <Button asChild size="sm" className="h-9 px-5 gap-1.5 font-semibold text-xs rounded-full">
            ...
            <>
              <Button asChild variant="ghost" size="sm" className="text-xs h-9 px-3 rounded-full text-muted-foreground hover:text-foreground">
