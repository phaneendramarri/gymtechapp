...
const AttendanceStep: React.FC = () => (
  <div className="space-y-3">
    ...
    <div
      ...
      style={{ border: '1px solid rgba(251,146,60,0.3)', backgroundColor: 'var(--iron-soft)' }}
    >
      ...
      <div className="flex items-center justify-between pt-2 border-t" style={{ borderColor: 'rgba(251,146,60,0.2)' }}>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at center, rgba(251,146,60,0.25) 0%, transparent 70%)' }}
      />
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg, transparent 0%, rgba(251,146,60,0.7) 50%, transparent 100%)' }}
        />
        ...
        <div className="flex items-center gap-3 px-5 py-3.5 border-b border-line" style={{ backgroundColor: 'var(--surface-2)' }}>
          ...
          <div className="flex gap-1.5 shrink-0">
            <div className="size-3.5 rounded-full" style={{ backgroundColor: 'rgba(251,146,60,0.8)' }} />
